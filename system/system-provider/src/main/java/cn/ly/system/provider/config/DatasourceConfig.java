package cn.ly.system.provider.config;
...
import cn.ly.common.service.datasource.DynamicDataSource;
import cn.ly.common.service.datasource.DynamicDataSourceTransactionManager;
import cn.ly.system.api.exception.base.SystemException;
...
public class DatasourceConfig {
	...
	public SqlSessionFactory dynamicSqlSessionFactory(@Qualifier("dynamicDataSource") DataSource dynamicDataSource,
		...
		//扫描entity 使用别名
		sessionFactory.setTypeAliasesPackage("cn.ly.system.provider.mapper");
		try {
